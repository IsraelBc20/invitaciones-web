...
// Galería del diseño Playa. La usan /playa/galeria (demo) y las galerías de
// clientes (p. ej. /playa/israel-y-marisol/galeria): todas leen las mismas
// fotos (design = 'playa'); solo cambia el enlace "Volver" (backHref).
...
export default function GalleryPlaya({
  backHref = "/playa",
  musicSrc = MUSIC_SRC,
}: {
  backHref?: string;
  // La galería de un cliente pasa la misma canción que su invitación
  // (p. ej. /playa/israel-y-marisol/music.mp3) para que el audio continúe.
  musicSrc?: string;
}) {
