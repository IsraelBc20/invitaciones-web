...
// Galería del diseño Oliva. La usan /oliva/galeria (demo) y las galerías de
// clientes (p. ej. /oliva/israel-y-marisol/galeria): todas leen las mismas
// fotos (design = 'oliva'); solo cambia el enlace "Volver" (backHref).
          ...
          return (
            <button
              ...
              style={{
                ...
                color: active ? "#f8f6f3" : "var(--accent)",
